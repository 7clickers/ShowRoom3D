...
\end{itemize} 
\input{res/sections/processi_supporto/verifica/verifica_documentazione.tex}
\input{res/sections/processi_supporto/verifica/verifica_codice.tex}
\input{res/sections/processi_supporto/verifica/metriche_verifica.tex}