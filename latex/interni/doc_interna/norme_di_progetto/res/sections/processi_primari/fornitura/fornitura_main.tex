...
\subsubsection{Scopo}
Lo scopo del processo di fornitura è quello di stabilire quali sono le attività, 
...
mantenere un rapporto attivo e vantaggioso con il proponente SanMarco Informatica. 

\subsubsection{Rapporti con il proponente}
Il gruppo si manterrà in contatto con il proponente regolarmente, organizzando incontri su Google Meet o 
comunicando in modo asincrono con email o Google Chat. Di seguito un elenco dei principali temi che possono essere 
motivo di confronto con il proponente: 
\begin{itemize} 
