...
\input{res/sections/fornitura/fornitura_main.tex}
\input{res/sections/sviluppo/sviluppo_main.tex}
\pagebreak
\section{Processi di Supporto}
\input{res/sections/documentazione/documentazione_main.tex}
\pagebreak
\input{res/sections/configurazione/configurazione_main.tex}
\pagebreak
\input{res/sections/gestione_qualita/gestione_qualita_main.tex}
\pagebreak
\input{res/sections/verifica/verifica_main.tex}
\pagebreak
\input{res/sections/validazione/validazione_main.tex}
\pagebreak
\section{Processi Organizzativi}
\input{res/sections/gestione_organizzativa/gestione_organizzativa_main.tex}
\pagebreak
\input{res/sections/gestione_infrastrutture/gestione_infrastrutture_main.tex}
\pagebreak
