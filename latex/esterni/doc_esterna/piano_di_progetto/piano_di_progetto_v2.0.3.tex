...
\pagebreak
\input{res/sections/02_modello_di_sviluppo_iniziale.tex}
\pagebreak
\input{res/sections/03_modello_di_sviluppo_attuale.tex}
\pagebreak
\input{res/sections/04_pianificazione.tex}
\pagebreak
\input{res/sections/05_Preventivo.tex}
\pagebreak
\input{res/sections/06_consuntivo.tex}
\pagebreak
\input{res/sections/07_attualizzazione_rischi.tex}
\pagebreak
\end{document}
