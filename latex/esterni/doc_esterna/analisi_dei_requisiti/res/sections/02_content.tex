...
\subsection{Attori}
Data l'ampiezza e struttura ridotta del software, l'attore\textsubscript{g} che interagisce col nostro software è uno solo, denominato "Utente in ambiente 3D". 

\subsubsection{Utente in ambiente 3D}
Si tratta dell'utente protagonista di tutti i casi d'uso del nostro prodotto\textsubscript{g}, chiamato tale dato che il software fornisce un immersione completa all'interno dello scenario 3D. \newline
...
\begin{itemize}
	...
	\item Attore\textsubscript{g} primario: 
	\begin{itemize}
		\item Utente in ambiente 3D.
	\end{itemize}
	\item Descrizione:
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Le azioni di movimento direzionali devono essere valide. Un'azione di movimento è considerata valida se l'attore\textsubscript{g} non va a collidere con un oggetto o una parete della stanza;
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item L'attore\textsubscript{g} si sposta in profondità.
	\end{itemize}
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item L'attore\textsubscript{g} si sposta in orizziontale.
	\end{itemize}
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item  L'attore\textsubscript{g} si sposta in verticale.
	\end{itemize}
...
\reqTable{
	...
	\textbf{RQ2} & Il software deve essere sviluppato pubblicando il codice sorgente sul repository\textsubscript{g} Github\textsubscript{g} dedicato & Obbligatorio & Decisione interna \tabularnewline
...
\reqTable{
	...
	\textbf{RD6} & Il software deve essere sviluppato utilizzando la libreria\textsubscript{g} Three.js & Obbligatorio & Decisione interna\tabularnewline
	\addlinespace 
