...
\subsubsection{UC10.2 - Visualizzazione peso}
\begin{itemize}
...
\subsubsection{UC10.3 - Visualizzazione colore}
\begin{itemize}
...
\subsubsection{UC10.4 - Visualizzazione larghezza}
\begin{itemize}
...
\subsubsection{UC10.5 - Visualizzazione altezza}
\begin{itemize}
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item L'utente visualizza la tipologia di oggetti nella stanza.
	\end{itemize}
...
\reqTable{
	...
	\textbf{RF19} & L'utente deve poter visualizzare un messaggio che indichi se il carrello è vuoto & Facoltativo & UC2 \tabularnewline
     ...
     \textbf{RF2.1.1} & L’utente può visualizzare un oggetto nel carrello & Obbligatorio & UC2.1.1\tabularnewline
     \textbf{RF2.1.1.1} & L'utente deve poter visualizzare il nome di ogni oggetto nella lista degli oggetti presenti nel carrello & Obbligatorio & UC2.1.1.1\tabularnewline
     \textbf{RF2.1.1.2} & L'utente deve poter visualizzare il costo di ogni oggetto nella lista degli oggetti presenti nel carrello & Obbligatorio & UC2.1.1.2\tabularnewline
     \textbf{RF2.1.1.3} & L'utente deve poter visualizzare la quantità di ogni oggetto nella lista degli oggetti presenti nel carrello & Obbligatorio & UC2.1.1.3\tabularnewline
...
\begin{longtable}{ 
	...
	\rowcolorhead \textcolor{white}{\textbf{Tutti requisiti}} & \textcolor{white}{\textbf{29}} & \textcolor{white}{\textbf{18}} & \textcolor{white}{\textbf{51}}
\end{longtable}
\subsection{Altre richieste del proponente}
In questa sezione vengono raccolti i vincoli implementativi richiesti dal proponente che non forniscono
funzionalità aggiuntive per l'utente ma descrivono il modo in cui l'ambiente 3D dovrà essere implementato.
I punti di interesse sono:
\begin{itemize}
	\item \textbf{Delimitatori stanze:} le stanze devono essere delimitate da delle pareti lasciando comunque uno o 
	più punti d'accesso tra una stanza e l'altra;
	\item \textbf{Identificatori per l'oggetto con cui si sta interagendo:} l'oggetto con il quale si sta interagendo
	deve apparire illuminato da una luce proveniente dall'alto e alla base deve essere
	visibile un cerchio che lo circonda;
	\item \textbf{Non persistenza del carrello:} il carrello al termine della sessione utente dovrà svuotarsi completamente
	per ripresentarsi completamente vuoto al prossimo accesso;
	\item \textbf{Collisioni con gli oggetti:} l'utente non deve poter entrare con la propria visuale all'interno degli oggetti
	attraversandoli.
\end{itemize}
