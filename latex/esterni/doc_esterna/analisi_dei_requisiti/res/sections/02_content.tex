...
\subsubsection{UC 3.1 - Visualizzazione oggetti presenti con relative caratteristiche e quantità}
...
\subparagraph{UC 3.1.1.1 - Visualizzazione icona}
\begin{itemize}
...
\subparagraph{UC 3.1.1.2 - Visualizzazione nome}
\begin{itemize}
...
\subparagraph{UC 3.1.1.3 - Visualizzazione costo}
\begin{itemize}
...
\subparagraph{UC 3.1.1.4 - Visualizzazione quantità}
\begin{itemize}
...
\subparagraph{UC 3.1.1.5 - Visualizzazione caratteristiche fisiche}
\begin{itemize}
...
\subsection{UC 9 - Visualizzazione contenuto lista oggetti}

\begin{figure}[H]
  \renewcommand{\thefigure}{5}
  \includegraphics[width=\linewidth]{./res/images/UC9.png}
  \caption{UC 9 - Visualizzazione contenuto lista oggetti}
  \label{fig:UC 9}
\end{figure}
...
\subsubsection{UC 9.1 - Visualizzazione oggetti stanza attuale}
\begin{itemize}
...
\subsection{UC 10 - Visualizzazione dettagli oggetto}
\begin{itemize}
