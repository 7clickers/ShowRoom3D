...
Utente che ha accesso a tutte le funzionalità del prodotto, esplora l'ambiente 3D ed interagisce con i suoi elementi.
\section{Casi d'uso}
\textbf{ATTENZIONE:} negli schemi sottostanti i casi d'uso facoltativi sono rappresentati in azzurro.
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item Prevede la rimozione di tutti gli oggetti presenti nel carrello con un comando.
	\end{itemize}
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item Prevede la visualizzazione di tutte le caratteristiche fisiche dell'oggetto.
	\end{itemize}
...
\reqTable{
	...
	\textbf{RF1.1} & L'utente deve poter rimuovere un oggetto dal carrello & Facoltativo & UC1.1 \tabularnewline
     \textbf{RF1.2} & L'utente deve poter rimuovere tutti gli oggetti dal carrello con un comando & Facoltativo & UC1.2\tabularnewline
     
     \textbf{RF2} & L'utente deve poter visualizzare il contenuto del carrello & Obbligatorio & UC2\tabularnewline
     \textbf{RF2.1} & L'utente deve poter visualizzare la lista degli oggetti presenti nel carrello & Obbligatorio & UC2.1\tabularnewline
...
prestabilito di una stanza da lui selezionata & Facoltativo & UC9.2\tabularnewline
	...
	\textbf{RF13} & L'utente non deve poter riposizionare un oggetto in una coordinata non legittima & Facoltativo & UC13\tabularnewline
