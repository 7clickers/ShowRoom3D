...
\subsection{UC 19- Visualizzazione dettagli oggetto nel carrello}

\begin{figure}[H]
  \renewcommand{\thefigure}{6}
  \includegraphics[width=\linewidth]{./res/images/UC19.png}
  \caption{UC 19 - Visualizzazione dettagli oggetto nel carrello}
  \label{fig:UC 19}
\end{figure}
...
\subsubsection{UC 19.1 - Visualizzazione icona}
\begin{itemize}
...
\subsubsection{UC 19.2 - Visualizzazione caratteristiche fisiche}
\begin{itemize}
