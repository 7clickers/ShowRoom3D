...
\subsubsection{UC 9.1 - Visualizzazione oggetto nella lista}

\begin{figure}[H]
  \renewcommand{\thefigure}{6}
  \includegraphics[width=\linewidth]{./res/images/UC9.1.png}
  \caption{UC 9.1 - Visualizzazione oggetto nella lista}
  \label{fig:UC 9.1}
\end{figure}
...
\subsubsection{UC 9.1.1 - Visualizzazione nome oggetto nella lista}
\begin{itemize}
...
\subsection{UC 15 - Visualizzazione lista stanze}
\begin{itemize}
	...
	\item Precondizioni:
	\begin{itemize}
		\item La lista delle stanze è nascosto.
	\end{itemize}
