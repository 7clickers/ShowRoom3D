...
\subsubsection{UC3.1 - Visualizzazione oggetti presenti}

\begin{figure}[H]
  \renewcommand{\thefigure}{2}
  \includegraphics[width=\linewidth]{./res/images/UC3.1.png}
  \caption{UC3.1 - Visualizzazione oggetti presenti con relative caratteristiche e quantità}
  \label{fig:UC 3.1}
\end{figure}
...
\begin{itemize}
	...
	\item Descrizione:
	\begin{itemize}
		\item Selezionando un oggetto, l'utente può visualizzarne i dettagli.
	\end{itemize}
	...
	\item Scenario principale:
	\begin{itemize}
		\item L'utente in ambiente 3D seleziona un oggetto.
	\end{itemize}
	
\end{itemize}

\subsubsection{UC10.1 - Visualizzazione icona}
\begin{itemize}
...
\subsubsection{UC10.2 - Visualizzazione caratteristiche fisiche}
\begin{itemize}
...
\reqTable{
	\textbf{RF1} & L'utente deve poter rimuovere un oggetto dal carrello & Facoltativo & UC1 \tabularnewline
     ...
     \textbf{RF10.2} & L'utente deve poter visualizzare le caratteristiche fisiche di un oggetto selezionato & Obbligatorio & UC10.2\tabularnewline
