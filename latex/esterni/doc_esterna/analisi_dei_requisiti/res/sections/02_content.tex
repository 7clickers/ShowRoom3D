...
\subsubsection{UC 4.2 - Compiere spostamenti camera}
\begin{itemize}
...
\reqTable{
	\textbf{RF1.1} & L'utente deve poter rimuovere un oggetto dal carrello & Obbligatorio & UC1.1 \tabularnewline
     \textbf{RF1.2} & L'utente deve poter rimuovere tutti gli oggetti dal carrello & Obbligatorio & UC1.2\tabularnewline
     
     \textbf{RF2} & L'utente deve poter visualizzare il contenuto del carrello & Obbligatorio & UC2\tabularnewline
     \textbf{RF2.1} & L'utente deve poter visualizzare gli oggetti presenti nel carrello singolarmente e le loro caratteristiche & Obbligatorio & UC2.1\tabularnewline
     ...
     \textbf{RF4.1} & L'utente deve poter compiere movimenti direzionali su i tre assi X, Y, Z & Obbligatorio & UC4.1\tabularnewline
     ...
     \textbf{RF7} & L'utente deve poter visualizzare il contenuto della lista oggetti & Obbligatorio & UC7\tabularnewline
     \textbf{RF7.1} & L'utente deve poter visualizzare il contenuto della lista oggetti della stanza attuale & Obbligatorio & UC7.1\tabularnewline
...
\reqTable{
	\textbf{RV1} & Il software deve essere compatibile con la versione più recente del browser Chrome & Obbligatorio & Decisione interna \tabularnewline
	\textbf{RV2} & Il software deve essere compatibile con la versione più recente del browser Firefox & Obbligatorio & Decisione interna \tabularnewline
	\textbf{RV3} & Il software deve essere compatibile con la versione più recente del browser Safari & Obbligatorio & Decisione interna \tabularnewline
	\textbf{RV4} & Il software deve essere sviluppato utilizzando la libreria Three.js & Obbligatorio & Decisione interna
	\\}
