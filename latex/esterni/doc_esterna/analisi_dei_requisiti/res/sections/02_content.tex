...
\subsection{UC1 - Visualizzazione contenuto del carrello}

\begin{figure}[H]
  \renewcommand{\thefigure}{1}
  \includegraphics[width=\linewidth]{./res/images/UC1.png}
  \caption{UC1 - Visualizzazione contenuto del carrello}
  \label{fig:UC 1}
\end{figure}
...
\subsubsection{UC1.1 - Visualizzazione lista oggetti presenti}

\begin{figure}[H]
  \renewcommand{\thefigure}{2}
  \includegraphics[width=\linewidth]{./res/images/UC1.1.png}
  \caption{UC1.1 - Visualizzazione lista oggetti presenti}
  \label{fig:UC 1.1}
\end{figure}
...
\paragraph{UC1.1.1 - Visualizzazione oggetto}

\begin{figure}[H]
  \renewcommand{\thefigure}{3}
  \includegraphics[width=\linewidth]{./res/images/UC1.1.1.png}
  \caption{UC1.1.1 - Visualizzazione oggetto}
  \label{fig:UC 1.1.1}
\end{figure}
...
\subparagraph{UC1.1.1.1 - Visualizzazione nome}
\begin{itemize}
...
\subparagraph{UC1.1.1.2 - Visualizzazione costo}
\begin{itemize}
...
\subparagraph{UC1.1.1.3 - Visualizzazione quantità}
\begin{itemize}
...
\subsubsection{UC1.2 - Visualizzazione costo totale oggetti}
...
\begin{figure}[H]
  ...
  \caption{UC2 - Svuotamento totale carrello}
  \label{fig:UC 2}
\end{figure}
...
\pagebreak
\subsection{UC3 - Rimozione oggetto singolo dal carrello}
...
\reqTable{
	...
	\textbf{RD4} & Il software deve essere sviluppato utilizzando la libreria Three.js & Obbligatorio & Decisione interna\tabularnewline
	\addlinespace 
