...
\subsection{UC2 - Svuotamento totale carrello}
\begin{itemize}
...
\subparagraph{UC3.1.1.1 - Visualizzazione nome}
\begin{itemize}
...
\subparagraph{UC3.1.1.2 - Visualizzazione costo}
\begin{itemize}
...
\subparagraph{UC3.1.1.3 - Visualizzazione quantità}
\begin{itemize}
...
\subsubsection{UC3.2 - Visualizzazione costo totale oggetti}
\begin{itemize}
...
\subsection{UC4 - Aggiungere un oggetto al carrello}
\begin{itemize}
...
\subsection{UC7 - Modificare attributi oggetto}
\begin{itemize}
...
\subsubsection{UC10.2 - Visualizzazione caratteristiche}
\begin{itemize}
...
\reqTable{
	\textbf{RQ1} & Il software deve essere sviluppato seguendo le metriche e il modello di qualità descritti nel documento "\textit{Norme di Progetto}" & Obbligatorio & Decisione interna \tabularnewline
...
\reqTable{
	...
	\textbf{RD4} & Il software deve essere sviluppato utilizzando la libreria\textsubscript{g} Three.js & Obbligatorio & Decisione interna\tabularnewline
	\addlinespace 
