...
La metrica di Code Coverage non è stata calcolata nello sviluppo del PoC. La metrica verrà eseguita successivamente in seguito ai Test nel codice del progetto.\\
\begin{longtable}{ 
...
\end{longtable}
I moduli utilizzati per il PoC, di cui è stato rilevante calcolare la Complessità Ciclomatica, sono:
\begin{longtable}{ 
