...
\begin{longtable}{
	...
	\endfirsthead	
	\endhead
MPC01 & Planned Value (PV) & $ \ge 0 $ & $ \le \text{Budget at Completion} $ \tabularnewline
MPC02 & Actual Cost (AC) & $ \ge 0 $ & $ \le \text{EAC} $\tabularnewline
MPC03 & Earned Value (EV) & $ \ge 0 $ & $ \le \text{EAC} $ \tabularnewline
MPC04 & Estimated at Completion (EAC) & preventivo -5\% $ \le \text{EAC} $ preventivo +5\% $ \ge \text{EAC} $   & Costo preventivato \tabularnewline
MPC05 & Estimated to Complete (ETC) & $ \ge 0 $ & $ \le \text{EAC} $ \tabularnewline
...
MPC11 & Metriche soddisfatte & $ \ge 90\% $ & 100\% \tabularnewline
...
In questa sezione vengono riportati i risultati dell'attività di verifica effettuata sui documenti Analisi dei requisiti, Glossario, Norme di progetto, Piano di qualifica, studio di fattibilità.
