...
export default function Map() {
  ...
  const { nodes, materials, scene } = useGLTF("src/assets/map/map_no_tunnel.glb");
...
<group dispose={null}>
      ...
      <group
        position={[-28.7, 0, -0.01]}
        rotation={[-Math.PI / 2, 0, 2.352]}
        scale={0.013}
      >
        <group position={[0.0002, 0, 0]} rotation={[Math.PI / 2, 0, 0]}>
      ...
      <group
        position={[41.62, 0, 27.4]}
        rotation={[-Math.PI / 2, 0, -2.2528]}
        scale={[0.012, 0.012, 0.013]}
      >
        <group position={[-0.0002, 0.0001, 0]} rotation={[Math.PI / 2, 0, 0]}>
          <group position={[-0.0002, 0, -0.0004]}>
            <group position={[-0.0002, 0, -0.0004]}>
              <mesh
                castShadow
                receiveShadow
      ...
      <group
        position={[64.4, 0, -2.65]}
        rotation={[-Math.PI / 2, 0, -0.5829]}
        scale={0.013}
      >
        <group position={[-0.0003, -0.0001, 0]} rotation={[Math.PI / 2, 0, 0]}>
          <group position={[-0.0003, 0, 0.0003]}>
            <group position={[-0.0003, 0, 0.0003]}>
              <mesh
                castShadow
                receiveShadow
      ...
      <group
        ...
        scale={0.013}
      >
        <group position={[-0.0004, -0.0002, 0]} rotation={[Math.PI / 2, 0, 0]}>
          <group position={[-0.0002, 0, 0.0001]}>
            <group position={[-0.0002, 0, 0.0001]}>
              <mesh
                castShadow
                receiveShadow
